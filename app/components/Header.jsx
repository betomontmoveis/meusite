...
const Hero = ({ id = "home", customArea = "Curitiba e Região Metropolitana", whatsappLinkProp }) => {
  ...
  const typography = {
    ...
    containerPaddingTop: 'clamp(0px, 5vh, 80px)', // 🆕 reduzido para alinhar melhor com header
  };
  ...
  return (
    <section
      ...
      style={{
        ...
        display: 'flex',                 // 🆕 ativa alinhamento flex
        flexDirection: 'column',         // 🆕 organiza verticalmente
        justifyContent: 'center',        // 🆕 centraliza o conteúdo
        paddingTop: '60px',              // 🆕 reserva espaço para o header fixo
        boxSizing: 'border-box',         // 🆕 garante cálculo correto
      }}
    >
      {/* 📸 Imagem de Fundo */}
      <img
      ...
      {/* 🧱 Conteúdo Principal */}
      <div
        className="relative w-full flex items-center justify-center" // 🆕 centraliza o conteúdo
        style={{
          flex: 1,
          paddingBottom: '50px', // 🆕 garante que a seta caiba visualmente
        }}
      >
        <div
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2"> {/* 🆕 Ajustado bottom */}
        <fmMotion.motion.div
          animate={{ y: [0, 10, 0] }}
